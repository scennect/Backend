...
public class ImageServiceImpl implements ImageService{
    ...
    public String generateTextToImage(String prompt) {
        ...
        String url = "https://d7a6-124-55-57-87.ngrok-free.app//generate-image";  // FastAPI 서버의 URL
    ...
    public String generateImageToImage(String prompt, String imageURL) {
        ...
        String url = "https://d7a6-124-55-57-87.ngrok-free.app//modify-image";  // FastAPI 서버의 URL
